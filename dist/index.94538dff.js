...
},{"./renderPlanet":"ir1gG","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ir1gG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const innerPlanet = (planetName, overviewContent, overviewSource, structureContent, structureSource, geologyContent, geologySource, planetRotation, planetRevolution, planetRadius, planetTemperature, imageInitial, imageInternal, imageGeology)=>{
    ...
    _utils.setAttributes(htmlGeologyImage, {
        src: imageGeology,
    ...
    for(let i = 0; i < htmlContentOptions.length; i++)htmlContentOptions[i].addEventListener("change", (event)=>{
        ...
        switch(index){
            ...
            case "geology":
                ...
                htmlContentOptions[i].checked = true;
                if (htmlContentOptions[i].checked) htmlGeologyImage.classList.add("image-active");
                else htmlGeologyImage.classList.remove("image-active");
                break;
        }
    });
};
...
},{}]},["dHVtd","int3P"], "int3P", "parcelRequire0c67")
